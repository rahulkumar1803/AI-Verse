...
function RemainingWords() {
    ...
    const progressText = `${fakeUser.cumulativeWords} / ${!fakeUser.isPro ? "100,000,000" : "100,000,000,000,000"} Words generated`
    const upgradeButtonText = "Upgrade to pro";
    function progressBarCalculation() {
        const divider = !fakeUser.isPro ? 100000000 : 100000000000000;
